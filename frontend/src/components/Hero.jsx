    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mb-8 animate-fade-in-up">
              <span className="font-bold text-xs tracking-[0.2em] uppercase text-[#00ff88]">
            ...
            >
              Tu próximo<br />
              equipo no tiene<br />
              <span className="font-black text-[#00ff88]">LinkedIn.</span>
            </h1>
          ...
          <div className="lg:col-span-4 hidden lg:flex items-center justify-center">
            <div className="relative">
              <div className="w-48 h-48 border border-white/10 flex items-center justify-center">
                <div className="text-[#00ff88] font-mono text-sm text-center">
                  <div className="mb-2">6 AGENTES</div>
                  <div className="text-4xl font-black">24/7</div>
                  <div className="mt-2">ACTIVOS</div>
                </div>
              </div>
              <div className="absolute -top-4 -right-4 w-48 h-48 border border-[#00ff88]/20" />
            </div>
          </div>
        </div>
        ...
        <div 
          ...
          onClick={scrollToAgents}
        >
          <ArrowDown className="text-neutral-600 hover:text-[#00ff88] transition-colors" size={24} />
        </div>
      </div>
    </section>
  );
