...
def get_gog_credentials():
    """Extract credentials from gog's storage with client_secret"""
    try:
        ...
        if result.returncode == 0:
            ...
            # Create credentials object with client_secret
            creds = Credentials(
                token=None,
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("• PRESUPUESTO PISCO DIABLO → PRESUPUESTO WORLD SKATE")
        print("• CREATIVIDAD OPERANDO EN MODO IA → PLATAFORMA CULTURAL GLOBAL EN MODO IA")
        print("• marca personal Malek → World Skate Platform")
        print("• Malek → World Skate") 
        print("• $2.100.000 → USD 17,500")
        print("• durante 2026 → durante 24 meses")
        print("• NO TALK. JUST RACE. → POWER TO MOVE SKATE FORWARD")
        print("• Pista, Proceso, Control, Evolución → Positioning, Image, Storytelling, Community")
        print("• Construcción → Presion → Evolución → Governing → Leading → Empowering")
        print("• 4-8 piezas de contenido por mes → 8-12 piezas de contenido por mes")
        print("• biblia de marca Malek → Brand Bible World Skate")
        print("• press kit de proyección internacional → press kit internacional para 130 federaciones")
    else:
